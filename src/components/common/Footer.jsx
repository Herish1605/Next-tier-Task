        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10 mb-10">
          ...
          <div>
            ...
            <ul className="space-y-4">
              <li><Link to="/landingpage.html" className="text-[16px] font-syne text-white">Landing Page</Link></li>
          ...
          <div>
            ...
            <ul className="space-y-4">
              <li><Link to="/" className="text-[16px] font-syne text-white">Hire telent</Link></li>
