      ...
      <div className="grid grid-cols-1 lg:grid-cols-1 gap-12 mb-12">
        ...
        >
          ...
          <div>
            ...
            <p className="text-[18px] font-syne leading-[30px] text-[#fcfcfc]">
              Get ahead of the competition with MakBig exclusive industry insights and trends. Our platform offers valuable content that keeps you up-to-date on the latest developments in your industry, allowing you to make informed decisions on your projects. With MakBig, you're always one step ahead.
            </p>
          </div>
        </Card>
        ...
        >
          ...
          <div>
            ...
            <p className="text-[18px] font-syne leading-[30px] text-[#fcfcfc] mb-12">
              Create an attractive employer brand: Develop a strong and appealing employer brand that showcases your company culture, values, and benefits. Highlight what makes your organization a great place to work.
            </p>
            <Button
              variant="primary"
